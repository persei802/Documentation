...
.. note:: Linuxcnc’s run-from-line is not very user friendly. eg. It does not start the spindle or confirm the proper tool. 
  It does not handle subroutines well. If used, it is best to start on a rapid move.

.. figure:: images/runfromline.png
  :width: 340
  :alt: Run From Line Dialog
